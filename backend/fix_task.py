...
- [ ] Update /discover frontend to use real business recommendations.
- [ ] Update Financials dashboard to display real engine calculation results.
- [ ] Update Score page to correctly break down dimensions based on scoring_engine.py.
- [ ] Update Simulator to run Python-side what-if queries rather than mock variations.
