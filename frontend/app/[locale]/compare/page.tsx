      ...
      <div className="overflow-x-auto pb-8">
        <table className="w-full min-w-[800px] border-collapse">
          ...
          <tbody className="divide-y divide-warm-border/50">
            ...
            <tr>
              <td className="p-4 font-semibold text-warm-muted">Projected Return on Investment</td>
              {compareData.map((biz: any) => (
      ...
      <div className="mt-8 bg-warm-primary/10 border border-warm-primary/20 rounded-xl p-6 flex items-start">
        ...
        <div>
          ...
          <p className="text-warm-muted text-sm leading-relaxed">
            While Retail has lower risk, Food Processing offers a significantly higher Return on Investment (24% vs 18%) and better Demand coverage in your target area of Solapur. If you are comfortable managing perishable inventory, Food Processing is our top recommendation.
          </p>
        </div>
      </div>
    </div>
