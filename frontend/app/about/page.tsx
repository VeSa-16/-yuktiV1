...
export default function AboutPage() {
  const pillars = [
    ...
    },
    {
      ...
      description: "Direct integration with central and state credit-linked subsidies like PMEGP, Mudra Y योजना, and MSME cluster initiatives."
    }
  ];
  ...
  const stats = [
    ...
    { label: "Bank-Ready DPRs", value: "15,000+" },
    { label: "Avg. Subsidy Matched", value: "35%" }
  ];
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 pt-28 pb-16 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="font-display font-bold text-4xl sm:text-5xl text-forest-deep mb-4 tracking-tight">
            About <span className="text-[#ea580c]">YUKTI</span>
          </h1>
        ...
        <div className="bg-white/80 backdrop-blur-md border border-emerald-900/10 p-8 sm:p-12 rounded-[2.5rem] shadow-sm mb-16 relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto text-center relative z-10">
            ...
            <p className="text-ink-soft text-base sm:text-lg leading-relaxed mb-6">
              YUKTI is a landmark initiative designed to bridge the gap between rural ambition and economic viability. We believe that lack of market data or complex paperwork should never stand in the way of a viable business.
            </p>
            <p className="text-ink-soft text-base sm:text-lg leading-relaxed">
              By placing institutional-grade market intelligence, financial modeling, and instant government scheme eligibility directly into the hands of citizens, YUKTI is driving the next wave of self-reliant micro-entrepreneurs across Bharat.
            </p>
          </div>
        </div>
