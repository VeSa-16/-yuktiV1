  ...
  const steps = [
    {
      ...
      description: "Enter your location and available capital. YUKTI instantly scans your local micro-economy and suggests hyper-local business opportunities with high success probabilities.",
    ...
    },
    {
      ...
      description: "Use our Smart Financial Engine to calculate your exact project cost, find matched government schemes (like PMEGP & Mudra), and simulate loan repayment scenarios.",
      highlights: ["PMEGP / Mudra subsidy match", "Break-even timeline estimate", "Cash flow forecasting"]
    },
    {
      step: "04",
      icon: <Rocket className="w-7 h-7 text-[#ea580c]" />,
      title: "Launch & Grow",
      description: "Export a bank-ready Detailed Project Report (DPR), track your implementation milestones on your dashboard, and get connected to verified local mentors and suppliers.",
      highlights: ["1-Click Bank-Ready DPR PDF", "Government scheme registration", "Verified local vendor network"]
    }
  ];
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 pt-28 pb-16 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="font-display font-bold text-4xl sm:text-5xl text-forest-deep mb-4 tracking-tight">
            How <span className="text-[#ea580c]">YUKTI</span> Works
          </h1>
