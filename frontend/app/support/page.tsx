...
export default function SupportPage() {
  ...
  const faqs = [
    {
      q: "Is YUKTI completely free to use for citizens?",
      a: "Yes, YUKTI is an official Government of India portal. All core micro-market intelligence features, project feasibility reports, and scheme matching tools are provided 100% free of charge to all Indian citizens."
    },
    {
    ...
    {
      q: "Can I apply for government loans directly through YUKTI?",
      a: "YUKTI helps you generate an official, bank-ready Detailed Project Report (DPR). You can submit this DPR to partnered public sector banks or upload it directly on the Jansamarth / PMEGP portals to expedite credit sanction."
    },
    {
      q: "Which government schemes are integrated into YUKTI?",
      a: "YUKTI supports prime credit-linked subsidy schemes including PMEGP (Prime Minister's Employment Generation Programme), PM Mudra Yojana, Stand-Up India, PM Formalisation of Micro Food Processing Enterprises (PMFME), and state-specific MSME policies."
    },
    {
      q: "Can I get assistance in my regional language?",
      a: "Yes, YUKTI supports 12 official Indian languages. You can switch your preferred language using the header dropdown menu."
    }
  ];
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 lg:px-8 pt-28 pb-16 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-base sm:text-lg text-ink font-medium max-w-2xl mx-auto leading-relaxed">
            Have questions about scheme eligibility, DPR generation, or business selection? We're here to assist you.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-emerald-900/10 p-8 rounded-[2rem] shadow-sm hover:shadow-md transition-all flex flex-col justify-between group">
            <div>
              ...
              <p className="text-ink-soft text-sm mb-6 leading-relaxed">
                Send your DPR queries or portal assistance requests. Guaranteed response within 24 hours.
              </p>
            </div>
        ...
        <div className="bg-white/80 backdrop-blur-md border border-emerald-900/10 p-8 sm:p-10 rounded-[2.5rem] shadow-sm">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-ink-soft">Quick answers to common questions about YUKTI</p>
            </div>
          </div>
