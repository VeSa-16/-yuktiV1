...
export function MapRadiusOverlay({ lat, lng, radiusKm, competitors = [] }: MapProps) {
  ...
  if (!mounted) {
    return <div className="w-full h-64 bg-warm-bg border border-warm-border animate-pulse rounded-none flex items-center justify-center text-warm-muted font-sans text-xs uppercase tracking-widest">Loading Map...</div>;
  }
